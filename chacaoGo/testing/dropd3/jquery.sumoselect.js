...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            ...
            captionFormat:'{0} {s}', // format of caption text. you can set your locale.
        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                multiSelelect: function () {
                    ...
                    O.cancelBtn = $('<p class="btnCancel">Cancelar</p>').click(function () {
                        O._cnbtn();
                        O.hideOpts();
                    });
...
//                                O.hideOpts();
                ...
                setText: function () {
                    ...
                    if (O.is_multi) {
                        ...
                        for (i = 0; i < sels.length; i++) {
                            if (i >= settings.csvDispCount && settings.csvDispCount) {
                                ...
                                O.placeholder = O.E.attr('placeholder') + " (" + sels.length + ")";
                                break;
                            }
                            else O.placeholder = O.E.attr('placeholder') + " (1)" ;
                        }
                    ...
                    //O.placeholder = settings.captionFormat.replace('{s}', O.E.attr('placeholder'););
